...
object GLUtils {
    ...
    private fun setColorBuffer(p_setColorBuffer_0_: Double, p_setColorBuffer_2_: Double, p_setColorBuffer_4_: Double, p_setColorBuffer_6_: Double): FloatBuffer? {
        return setColorBuffer(p_setColorBuffer_0_.toFloat(), p_setColorBuffer_2_.toFloat(), p_setColorBuffer_4_.toFloat(), p_setColorBuffer_6_.toFloat())
    }

    private fun setColorBuffer(p_setColorBuffer_0_: Float, p_setColorBuffer_1_: Float, p_setColorBuffer_2_: Float, p_setColorBuffer_3_: Float): FloatBuffer? {
        colorBuffer!!.clear()
    ...
    private val glCapMap: HashMap<Any?, Any?> = HashMap<Any?, Any?>()
}
