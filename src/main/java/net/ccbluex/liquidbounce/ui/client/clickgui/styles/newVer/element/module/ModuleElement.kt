package net.ccbluex.liquidbounce.ui.client.clickgui.styles.newVer.element.module

import net.ccbluex.liquidbounce.features.module.Module
import net.ccbluex.liquidbounce.ui.client.clickgui.styles.newVer.ColorManager
import net.ccbluex.liquidbounce.ui.client.clickgui.styles.newVer.element.components.ToggleSwitch
import net.ccbluex.liquidbounce.ui.client.clickgui.styles.newVer.element.module.value.ValueElement
import net.ccbluex.liquidbounce.ui.client.clickgui.styles.newVer.element.module.value.impl.*
import net.ccbluex.liquidbounce.ui.client.clickgui.styles.newVer.extensions.animSmooth
